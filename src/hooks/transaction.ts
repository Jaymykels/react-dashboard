...
export const getTransactionBranchChartData = (data: GetAllTransactionsData): {series: any[], categories: string[]} => {
...
export const getTransactionPeriodChartData = (data: GetAllTransactionsData, variables: GetAllQueryFilter): {series: any[], categories: string[]} => {
